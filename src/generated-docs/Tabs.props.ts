...
export const tabsPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional stable base used to create ids: `${idBase}-tab-${i}` and `${idBase}-panel-${i}`",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        'Rounding of the tabs. "none" | "small" | "medium" | "large" | "full"',
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        'Shadow style of the tabs. "none" | "light" | "medium" | "strong" | "intense"',
      required: false,
      inherited: false,
      category: "styling",
    },
    {
      ...
      type: "SizeType",
      description:
        'Size of the tabs. "xs" | "small" | "medium" | "large" | "xl"',
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "StateType",
      description:
        'State of the tabs. "success" | "error" | "warning" | "disabled" | ""',
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        'Theme for styling the tabs. "primary" | "secondary" | "tertiary" | "quaternary" | "clear"',
      required: false,
      inherited: false,
      category: "styling",
