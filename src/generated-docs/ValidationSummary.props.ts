...
export const validationSummaryPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      description:
        "Optional icon rendered before the summary title. Accepts Font Awesome icons, SVG elements, or custom React elements.",
      required: false,
      inherited: false,
      category: "props",
    },
    {
      ...
      type: "string",
      description:
        "Accessible label for the icon when it communicates meaning. If omitted, the icon is treated as decorative.",
      required: false,
      inherited: false,
      category: "props",
    },
