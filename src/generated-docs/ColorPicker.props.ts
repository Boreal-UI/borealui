...
export const colorPickerPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        "References one or more elements that describe the group. This will be merged with helperText / errorText IDs when provided.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "Accessible name for the group when no visible label should be used or when a more descriptive label is needed.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "References an external element that labels the group. Prefer this when the visible label exists outside the component.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        "Applies a shadow effect to the swatches ('none' | 'light' | 'medium' | 'strong' | 'intense').",
      required: false,
      inherited: false,
      category: "styling",
