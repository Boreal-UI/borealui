  ...
  props: [
    {
      ...
      type: "string",
      description:
        "ID reference for describing the accordion toggle button. This can supplement or replace the generated description ID.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "Accessible label for the accordion toggle button. Useful when the visible title is not descriptive enough.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "ID reference for labeling the accordion toggle button. Prefer this when an external visible label already exists.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Accessible description. This can be announced to assistive technologies via aria-describedby.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional custom ID for the accordion content section. If not provided, a unique ID will be generated.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      description:
        "Callback triggered when the accordion header is toggled. Receives the new expanded state.",
      required: false,
      inherited: false,
      category: "events",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Accessible label for the expanded content region. Usually not needed if ariaLabelledBy/aria-labelledby is already sufficient.",
      required: false,
      inherited: false,
      category: "props",
    },
    {
      ...
      type: "string",
      description:
        "ID reference for labeling the content region. Overrides the default button-based relationship when needed.",
      required: false,
      inherited: false,
      category: "props",
    },
    {
      ...
      type: "React.AriaRole",
      description:
        "Optional role override for the outer wrapper. Leave undefined in most cases.",
      required: false,
      inherited: false,
      category: "aria",
    },
