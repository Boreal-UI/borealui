...
export const breadcrumbsPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        'Accessible label for the breadcrumb navigation. Defaults to "Breadcrumbs".',
      required: false,
      inherited: false,
      category: "aria",
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional ID of another element that labels this breadcrumb navigation. Prefer this when a visible heading already exists.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        "Rounding style to apply to the breadcrumbs ('none' | 'small' | 'medium' | 'large' | 'full').",
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        "Shadow style to apply to the breadcrumbs ('none' | 'light' | 'medium' | 'strong' | 'intense').",
      required: false,
      inherited: false,
      category: "styling",
    },
    {
      ...
      type: "SizeType",
      description:
        "Size of the breadcrumbs ('xs' | 'small' | 'medium' | 'large' | 'xl').",
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "StateType",
      description:
        "State of the breadcrumbs ('success' | 'error' | 'warning' | 'disabled' | ''). Used for visual feedback.",
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        "Theme style to apply to the breadcrumbs ('primary' | 'secondary' | 'tertiary' | 'quaternary' | 'clear').",
      required: false,
      inherited: false,
      category: "styling",
