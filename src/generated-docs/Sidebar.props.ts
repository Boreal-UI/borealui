...
export const sidebarPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        "Accessible label for the navigation landmark. Prefer the kebab-case ARIA prop for consistency with other React ARIA props.",
      required: false,
      inherited: false,
      category: "aria",
    ...
    },
    {
      ...
      type: "string",
      description:
        "ID reference to one or more elements that label the sidebar navigation landmark. Takes precedence over aria-label when both are provided.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        'Optional label for the footer landmark when footer content is rendered. Example: "Sidebar footer links"',
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      type: "string",
      description:
        'Optional version string displayed in the sidebar footer. Example: "v1.2.3"',
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "((link: SidebarLink, isOpen: boolean) => string)",
      description:
        "Optional accessible label generator for expandable parent items. Useful when you want screen readers to hear something more descriptive than the visible text alone.",
      required: false,
      inherited: false,
      category: "events",
    },
    ...
    },
    {
      ...
      type: "SidebarLink[]",
      description:
        "Array of navigation links to render in the sidebar. Each link may optionally include a nested submenu.",
      required: true,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        'Rounding style for the sidebar container. - "none" | "small" | "medium" | "large" | "full"',
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        'Shadow style for the sidebar container. - "none" | "light" | "medium" | "strong" | "intense"',
      required: false,
      inherited: false,
      category: "styling",
    },
    {
      ...
      type: "boolean",
      description:
        "Whether to display a footer section at the bottom of the sidebar. Defaults to `false`.",
      required: false,
      inherited: false,
      category: "props",
      defaultValue: "false",
    },
    {
      ...
      type: "StateType",
      description:
        'State variant for styling. Typically used to apply semantic states to the component. - "success" | "error" | "warning" | "disabled" | ""',
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        'Theme for styling. Determines the base color scheme for the sidebar. - "primary" | "secondary" | "tertiary" | "quaternary" | "clear"',
      required: false,
      inherited: false,
      category: "styling",
