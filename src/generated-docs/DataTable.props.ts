  ...
  props: [
    {
      ...
      type: "string",
      description:
        "Accessible description reference for the table. Useful for tying helper or instructional text to the table.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "Accessible label for screen readers. Use this when there is no visible caption or heading tied to the table.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "Accessible labelledby reference for the table. Prefer this when a visible heading already labels the table.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional visible or screen-reader-only caption text for the table. A table caption is the preferred built-in table label.",
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      type: "number",
      description:
        "Total column count override. Helpful when rendering dynamic or grouped columns in advanced cases.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      description:
        "Optional row description for screen readers. Only used when rows are interactive.",
      required: false,
      inherited: false,
      category: "events",
    },
    {
      ...
      type: "((row: T, index: number) => string)",
      description:
        "Optional accessible label for interactive rows. Only used when onRowClick is provided.",
      required: false,
      inherited: false,
      category: "events",
    },
    ...
    },
    {
      ...
      description:
        "Live region text announced when sorting changes. Receives the active column and current order.",
      required: false,
      inherited: false,
      category: "events",
    },
    {
      ...
      description:
        "Accessible label for the sort buttons/controls. Receives the column label and current sort order.",
      required: false,
      inherited: false,
      category: "events",
    },
    {
      ...
      type: "boolean",
      description:
        "Whether the caption should be visually hidden. Useful when you want semantic labeling without visible UI.",
      required: false,
      inherited: false,
      category: "props",
      defaultValue: "true",
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        "Rounding style for the table ('none' | 'small' | 'medium' | 'large' | 'full').",
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "number",
      description:
        "Total row count override. Helpful for virtualized or server-paginated tables.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        "Shadow style for the data table ('none' | 'light' | 'medium' | 'strong' | 'intense').",
      required: false,
      inherited: false,
      category: "styling",
    },
    {
      ...
      type: "StateType",
      description:
        "State of the table ('success' | 'error' | 'warning' | 'disabled' | '').",
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        "Theme used for styling the table ('primary' | 'secondary' | 'tertiary' | 'quaternary' | 'clear').",
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "boolean",
      description:
        "Allows table cells to wrap onto multiple lines. Can be overridden per column with column.wrap.",
      required: false,
      inherited: false,
      category: "props",
      defaultValue: "false",
