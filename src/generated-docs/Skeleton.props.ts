...
export const skeletonPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional ARIA label for the skeleton. Preferred when you want to directly label the status region.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Accessibility label for screen readers. Used as fallback hidden descriptive text when announce is enabled.",
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      type: "React.AriaRole",
      description:
        'Optional semantic role override. Defaults to "status" when announce is enabled.',
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "RoundingType",
      description:
        'Rounding of the skeleton. "none" | "small" | "medium" | "large" | "full"',
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        'Shadow style for the skeleton loader. "none" | "light" | "medium" | "strong" | "intense"',
      required: false,
      inherited: false,
      category: "styling",
