...
export const fileUploadPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        "Rounding of the control button ('none' | 'small' | 'medium' | 'large' | 'full').",
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        "Shadow of the control button ('none' | 'light' | 'medium' | 'strong' | 'intense').",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        "Rounding of the wrapping element ('none' | 'small' | 'medium' | 'large' | 'full').",
      required: false,
      inherited: false,
      category: "props",
      defaultValue: 'configured default rounding (fallback: "medium")',
    },
    {
      ...
      type: "ShadowType",
      description:
        "Shadow of the wrapping element ('none' | 'light' | 'medium' | 'strong' | 'intense').",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "StateType",
      description:
        "The state of the file upload ('success' | 'error' | 'warning' | 'disabled' | '').",
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        "Theme for the buttons and progress bar ('primary' | 'secondary' | 'tertiary' | 'quaternary' | 'clear').",
      required: false,
      inherited: false,
      category: "styling",
