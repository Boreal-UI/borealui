...
export const chipPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        'Custom accessible label for the close button. Defaults to "Close notification".',
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      type: "boolean",
      description:
        "Whether the leading icon is decorative. When true, it will be hidden from assistive technology. Defaults to true.",
      required: false,
      inherited: false,
      category: "props",
      defaultValue: "true",
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional ID for the message element. If omitted, a stable fallback based on testId/id is used.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "PositionType",
      description:
        "Position of the chip on the screen ('topLeft' | 'topCenter' | 'topRight' | 'bottomLeft' | 'bottomCenter' | 'bottomRight').",
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        "Rounding style for the chip ('none' | 'small' | 'medium' | 'large' | 'full').",
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        "Shadow style for the chip ('none' | 'light' | 'medium' | 'strong' | 'intense').",
      required: false,
      inherited: false,
      category: "styling",
    },
    {
      ...
      type: "SizeType",
      description:
        "Size of the chip ('xs' | 'small' | 'medium' | 'large' | 'xl').",
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "StateType",
      description:
        "State of the chip ('success' | 'error' | 'warning' | 'disabled' | '').",
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        "Theme color for the chip ('primary' | 'secondary' | 'tertiary' | 'quaternary' | 'clear').",
      required: false,
      inherited: false,
      category: "styling",
