...
export const toolbarPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        "Accessible name for the toolbar. Prefer this over the legacy `ariaLabel` prop.",
      required: false,
      inherited: false,
      category: "aria",
    ...
    },
    {
      ...
      type: "string",
      description:
        "References another element that labels the toolbar. Prefer this over `aria-label` when there is visible text available.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "AttachmentType",
      description:
        'How the toolbar attaches to the viewport or page layout. "static" | "fixed" | "sticky"',
      required: false,
      inherited: false,
      category: "props",
      defaultValue: '"static"',
    ...
    {
      name: "avatar",
      type: '{ name?: string; src?: string; size?: SizeType; shape?: "circle" | "square" | "rounded"; theme?: ThemeType; onClick?: (e: MouseEvent<HTMLButtonElement | HTMLAnchorElement>) => void; "aria-label"?: string; variant?: import("@/types/types").VariantType; }',
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional additional class names for the center section wrapper. Alias for `centerSectionClassName`.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional additional class names for the left section wrapper. Alias for `leftSectionClassName`.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional additional class names for the right section wrapper. Alias for `rightSectionClassName`.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        'Rounding of the component. "none" | "small" | "medium" | "large" | "full"',
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        'Shadow of the component. "none" | "light" | "medium" | "strong" | "intense"',
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        'The visual theme of the toolbar. "primary" | "secondary" | "tertiary" | "quaternary" | "clear"',
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional additional class name for the toolbar title element. Useful when consumers need to style the title directly.",
      required: false,
      inherited: false,
      category: "props",
    },
    {
      ...
      type: "string",
      description:
        "Optional id used for the rendered title element. Useful for linking the toolbar with `aria-labelledby`.",
      required: false,
      inherited: false,
      category: "props",
    },
