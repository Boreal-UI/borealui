...
export const spinnerPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "string",
      description:
        'Accessible label announced by screen readers. Falls back to `label`, then "Loading".',
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "ID of element(s) that label the spinner. Takes precedence over `aria-label` when provided.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        'Shadow style for the spinner. One of: "none" | "light" | "medium" | "strong" | "intense"',
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "StateType",
      description:
        'The state of the spinner. One of: "success" | "error" | "warning" | "disabled" | ""',
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        'The theme color of the spinner. One of: "primary" | "secondary" | "tertiary" | "quaternary" | "clear"',
      required: false,
      inherited: false,
      category: "styling",
