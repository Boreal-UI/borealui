  ...
  props: [
    {
      ...
      type: "string",
      description:
        "Legacy accessible description text rendered internally as visually hidden content. Prefer using `aria-describedby` when referencing external help text.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        "Optional id of external descriptive content. This will be merged with internally generated description ids.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      description:
        "Called when the textarea value changes. Receives the current string value and the original change event.",
      required: false,
      inherited: false,
      category: "events",
    },
