...
export const textInputPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      description:
        "Called when the input value changes. Returns both the current value and the original change event.",
      required: false,
      inherited: false,
      category: "events",
    },
    ...
    },
    {
      ...
      type: "React.AriaRole",
      description:
        "Declares the role when this input is used in advanced patterns such as searchbox, combobox, or spinbutton.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "ReactNode",
      description:
        "Optional content rendered for assistive technologies only. Useful for dynamic status or extra context.",
      required: false,
      inherited: false,
      category: "props",
    },
    {
      ...
      type: "StateType",
      description:
        'State of the input. "success" | "error" | "warning" | "disabled" | ""',
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "ThemeType",
      description:
        'Theme used for styling. "primary" | "secondary" | "tertiary" | "quaternary" | "clear"',
      required: false,
      inherited: false,
      category: "styling",
