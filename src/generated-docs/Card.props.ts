...
export const cardPropDocs: GeneratedComponentDoc = {
  ...
  props: [
    ...
    },
    {
      ...
      type: "BorderType",
      description:
        "Optional border width for the card ('none' | 'xs' | 'small' | 'medium' | 'large' | 'xl').",
      required: false,
      inherited: false,
      category: "props",
      defaultValue: 'configured default border width (fallback: "none")',
    },
    {
      name: "cardIcon",
      type: "IconType",
    ...
    },
    {
      ...
      description:
        "Image URL or static asset used as the card's visual. Can be a string or an object with { src, width, height }.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      description:
        "Layout orientation of the card ('horizontal' | 'vertical').",
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      description:
        "Optional rounding style for the card ('none' | 'small' | 'medium' | 'large' | 'full').",
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        "Optional shadow style for the card ('none' | 'light' | 'medium' | 'strong' | 'intense').",
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      type: "StateType",
      description:
        "State of the card ('success' | 'error' | 'warning' | 'disabled' | '').",
      required: false,
      inherited: false,
      category: "styling",
    },
    ...
    },
    {
      ...
      inherited: false,
      category: "props",
      defaultValue: 'dataTestId ?? "card"',
    },
    {
      name: "theme",
      type: "ThemeType",
      description:
        "Theme style to apply to the card ('primary' | 'secondary' | 'tertiary' | 'quaternary' | 'clear').",
      required: false,
      inherited: false,
      category: "styling",
