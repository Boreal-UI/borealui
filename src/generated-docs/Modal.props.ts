  ...
  props: [
    {
      ...
      type: "string",
      description:
        "The id of an element that describes the modal dialog. Useful for linking help text, instructions, or supporting content.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "Accessible label for the modal dialog. Use this when the modal does not have a visible title or when you want to provide a custom accessible name for screen readers.",
      required: false,
      inherited: false,
      category: "aria",
    },
    {
      ...
      type: "string",
      description:
        "The id of an element that labels the modal dialog. Prefer this when a visible heading or custom header should act as the dialog label.",
      required: false,
      inherited: false,
      category: "aria",
    },
    ...
    },
    {
      ...
      type: "string",
      description:
        'Accessible label for the close button. Defaults to "Close modal" in the base implementation.',
      required: false,
      inherited: false,
      category: "props",
    ...
    },
    {
      ...
      type: "boolean",
      description:
        "Controls whether the modal is open. - If omitted, the modal is considered open when rendered. - If provided, the modal opens/closes based on this value.",
      required: false,
      inherited: false,
      category: "props",
    },
    ...
    },
    {
      ...
      type: "RoundingType",
      description:
        'Rounding of the modal corners. One of: "none" | "small" | "medium" | "large" | "full"',
      required: false,
      inherited: false,
      category: "styling",
    ...
    },
    {
      ...
      type: "ShadowType",
      description:
        'Shadow of the modal. One of: "none" | "light" | "medium" | "strong" | "intense"',
      required: false,
      inherited: false,
      category: "styling",
