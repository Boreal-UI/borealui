...
| Data, charts, and content        | `DataTable`, `Sparkline`, `BarChart`, `LineChart`, `DonutChart`, `Legend`, `TrendBadge`, `MarkdownRenderer`, `MetricBox`, `Card`, `Avatar`                                                                                                                                                                                                                                    |
...
| `TrendBadge`           | `boreal-ui/core/TrendBadge`           | `boreal-ui/next/TrendBadge`           |
