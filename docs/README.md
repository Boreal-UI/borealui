# Boreal UI Consumer API Guides

These guides cover the public APIs consumers use when installing, importing, styling, theming, testing, and documenting with Boreal UI.
